...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/nvim-configuration/release-1.0/install.sh -O -)"
```
...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/nvim-configuration/release-1.0/uninstall.sh -O -)"
```
