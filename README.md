...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/dotfiles/minimal-no-shit/install.sh -O -)"
```
...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/dotfiles/minimal-no-shit/uninstall.sh -O -)"
```
