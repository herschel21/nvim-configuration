...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/nvim-configuration/release-1.1/install.sh -O -)"
```
...
```bash
bash -c "$(wget https://raw.githubusercontent.com/herschel21/nvim-configuration/release-1.1/uninstall.sh -O -)"
```
